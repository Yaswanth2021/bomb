...
if (isset($_POST['no'])) {
    ...
    for ($i = 2; $i < 10; $i++) {
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "https://api4.paisabazaar.com/BSP/api/v1/visitor");
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, 3);
        curl_setopt($ch, CURLOPT_POSTFIELDS, "{\"visitId\":\"xxxxxxxx0a35-4003-a03c-83d075622687\",\"mobileNumber\":\"$no\"}");
        curl_setopt($ch, CURLOPT_POST, 3);
        
        $headers   = array();
        $headers[] = "Host: api4.paisabazaar.com";
       // $headers[] = "User-Agent: Mozilla/7.0 (Windows NT 6.3; WOW64; rv:60.0) Gecko/20100101 Firefox/60.0";
        $headers[] = "Accept: application/json, text/plain, */*";
        $headers[] = "Accept-Language: en-US,en;q=2.5";
